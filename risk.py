...
def agent_risk_analyst(data_str: str) -> str:
    ...
    prompt = f"You are Agent 2: The Risk Analyst. Analyze the Volatility, Max Drawdown, and Sharpe ratios to determine risk-adjusted performance. Keep it to 3-4 sentences.\nData: {data_str}"
